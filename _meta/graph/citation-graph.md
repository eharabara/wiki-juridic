...
Generat 2026-09-24 23:17 de `_meta/graph/build_citation_graph.py`. Nu edita de mina; se reface rulind scriptul. Datele: `citation-graph.json` in acelasi folder.
...
| | |
|---|---:|
| acte primare detinute (din care ancorate pe articole) | 117 (88) |
| dispozitii (noduri-articol) | 12761 |
| extrase UE detinute (noduri-tinta) | 35 |
| acte citate si nedetinute (noduri externe) | 590 |
| mentiuni de acte in text (din care ale actului insusi) | 4607 (432) |
| muchii act -> act (agregate pe segment-sursa) | 3030 |
| trimiteri la articole citite (in grupuri de enumerare) | 9661 (8481) |
|   rezolvate in actul curent | 7879 |
|   rezolvate in alt act detinut | 1193 |
|   nerezolvate: articolul nu are ancora in actul-tinta | 101 |
|   catre acte nedetinute (notate pe muchia act -> act) | 399 |
|   catre acte pe puncte (fara articole) | 68 |
|   autoreferinte (articolul se citeaza pe sine), ignorate | 21 |
| muchii articol -> articol (agregate) | 7395 |
| muchii articol -> act nerezolvate (agregate) | 89 |

Regula care a dat actul-tinta, pe trimiteri: din 1429, doua-puncte 46, intern 7649, modificare 38, paranteza 11. „intern” = niciun act in context, deci actul curent; „din” = `art. N ... din Legea X` sau `(art. N, M) Directiva X`; „paranteza” = `Legea X (art. N)`; „doua-puncte” = `din Codul X: art. N, M`; „modificare” = `Legea X se modifica dupa cum urmeaza: ... articolul N`. `din legea indicata` trimite la ultima lege numita in acelasi segment.
...
| `L-768-2000` Legea nr. 768/2000 | 11 | 2 | `L-436-2006` (9) | art. 5 (x6) |
...
| `L-241-2007` Legea nr. 241/2007 | 8 | 4 | `L-72-2025` (4) | art. 2 |
...
| `EU-L-2018-1972` Directiva 2018/1972 | 3 | 1 | `L-72-2025` (3) | - |
...
| act citat | mentiuni | acte care il citeaza | cel mai des din | articole citate |
|---|---:|---:|---|---|
| `LEGE:protectia-datelor-cu-caracter` Legea privind protecția datelor cu caracter personal | 21 | 4 | `OCNPDCP-POLITIE-2013` (12) | art. 3 (x2), art. 4 (x2), art. 29 (x2), art. 11 |
...
|---|---|---|---:|---:|---|
| `L-133-2011` | 2026-08-23 | LP195 din 25.07.24 | 73 | 27 | art. 1, art. 2, art. 4, art. 5, art. 6, art. 12, art. 13, art. 20 |

`L-133-2011` este citat din: `COD-122-2003`, `COD-218-2008`, `COD-95-2021`, `DCNPDCP-581-2015`, `DCU-REGULI-2026`, `HCNPF-14-5-2016`, `L-105-2003`, `L-114-2012`, `L-122-2008`, `L-132-2016`, `L-1543-1998`, `L-171-2012`, `L-181-2023`, `L-195-2024`, `L-202-2017`, `L-246-2018`, `L-284-2004`, `L-308-2017`, `L-325-2013`, `L-325-2025`, `L-384-2023`, `L-436-2006`, `L-548-1995`, `L-72-2025`, `OCNPDCP-03-1-2013`, `OCNPDCP-39-2026`, `OCNPDCP-POLITIE-2013`.
...
Stari atasate dispozitiilor, in total: 60 in-force, 102 HCC, 267 abrogat. 90 dintre ele au cel putin o citare intrata, 28 din alte acte.
...
| `CC-1107-2002` | 2657 | 27 | 35 | 1017 | 5 | 1 | 24 |
| `CETS-223-2018` | 40 | 0 | 0 | 113 | 0 | 1 | 0 |
| `COD-116-2018` | 260 | 13 | 36 | 106 | 10 | 1 | 5 |
| `COD-1163-1997` | 511 | 66 | 25 | 447 | 20 | 1 | 78 |
| `COD-122-2003` | 658 | 26 | 14 | 471 | 219 | 2 | 25 |
| `COD-154-2003` | 416 | 26 | 15 | 198 | 3 | 0 | 23 |
| `COD-174-2018` | 98 | 18 | 6 | 71 | 7 | 0 | 15 |
| `COD-218-2008` | 737 | 57 | 37 | 508 | 50 | 10 | 77 |
| `COD-22-2024` | 96 | 26 | 5 | 18 | 5 | 0 | 26 |
| `COD-225-2003` | 540 | 23 | 22 | 213 | 31 | 17 | 14 |
| `COD-325-2022` | 252 | 36 | 11 | 164 | 22 | 0 | 26 |
| `COD-434-2023` | 390 | 44 | 9 | 137 | 18 | 1 | 61 |
| `COD-443-2004` | 361 | 30 | 20 | 129 | 75 | 0 | 21 |
| `COD-95-2021` | 472 | 37 | 3 | 430 | 8 | 0 | 31 |
| `COD-985-2002` | 566 | 22 | 25 | 166 | 3 | 1 | 12 |
| `CONST-1994` | 157 | 4 | 38 | 13 | 1 | 0 | 5 |
...
| `L-181-2014` | 89 | 31 | 16 | 30 | 2 | 1 | 33 |
| `L-181-2023` | 50 | 19 | 3 | 13 | 21 | 0 | 12 |
| `L-183-2012` | 110 | 28 | 7 | 183 | 8 | 4 | 16 |
...
| `L-199-2010` | 29 | 8 | 10 | 2 | 5 | 0 | 3 |
| `L-2-2020` | 46 | 17 | 0 | 29 | 8 | 1 | 11 |
| `L-20-2026` | 29 | 18 | 1 | 16 | 15 | 0 | 12 |
| `L-202-2017` | 155 | 21 | 18 | 247 | 31 | 2 | 10 |
| `L-213-2023` | 10 | 6 | 9 | 5 | 2 | 1 | 3 |
| `L-220-2007` | 44 | 10 | 12 | 14 | 15 | 0 | 9 |
