...
- **Hotărîrile CCR fără articol atribuit: recuperate 2026-09-25** (secțiunea AW). **Neexecutat:** citirea integrală a celor 54 de acte; consolidările viitoare (23) neingerate.

## AW. Cinci hotărîri CCR fără articol atribuit, recuperate (2026-09-25)

- **Cererea:** „recuperează cele 5 hotărîri CCR fără articol atribuit”, rămase la `L-283-2003`, `L-303-2013`, `L-382-2001` și `L-93-1998` după ingerarea celor 54 de acte.
- **Metoda (regula din `_meta/hcc/`):** lista de versiuni din `showdetails`, versiunea produsă de hotărîre, marcajul din text, apoi dispozitivul hotărîrii însăși. 8 dispoziții noi în `recovered-provisions.json` (adăugate textual, fără a reformata fișierul); registrul: 126 recuperate, 0 fără articol.
- **Ce a ieșit:** `HCC11/2023` lovește art. 22^1 alin. (1) lit. c) (text) și art. 27^3 lit. d) din `L-283-2003`; marcajul scria „Art.27 3”, adică exponent turtit, art. 27^3, nu art. 27 alin. (3). `HCC28/2016` și `HCC30/2016` lovesc sintagme din art. 19 alin. (5), respectiv (4), din `L-303-2013`; marcajul lui HCC28 stă la sfîrșitul art. 19, nu lîngă alin. (5), deci articolul vine din dispozitiv, nu din poziție. `HCC28/2002` lovește „…și rusă” din art. 10 și art. 11 alin. (1) din `L-382-2001`; marcajul, unul singur, nu numește articolul. `HCC7/1999` lovește art. 14 alin. (1) și art. 19 alin. întîi subalin. doi din `L-93-1998`.
- **Două lucruri de metodă:** (a) un marcaj nu dă articolul: la trei din cinci sta după un alt alineat sau la sfîrșitul articolului, iar dispozitivul a fost decisiv; (b) `HCC7/1999` nu se găsea pe legis.md prin căutare pe titlu (nici după număr, nici după cuvinte), deci textul e de pe constcourt.md (`ro_1999_h_07.pdf`), înregistrat ca `decision_doc_id` `ccdoc:ro_1999_h_07.pdf`, după convenția `ccdoc:` a fișierului. Referința MO diferă între trei surse (hotărîre: MO22-23/13 din 04.03.1999; marcaj: MO22-23/13 25.02.99; fișă: MO19/25.02.99).
- **Neexecutat:** verificarea că nu există și alte hotărîri CCR care ating aceste patru acte fără să fie în fișă; hotărîrea din `HCC30/2016` lovește și art. 5 alin. (4^1) din Legea 272/1999 (nu e în vault); `HG 947/1998` (lovită de HCC7/1999) nu e în vault.

## AX. Consolidările viitoare ingerate ca fișiere separate (2026-09-25)

- **Cererea:** „ingerează consolidările viitoare neingerate”. Erau două liste cu același nume: cele 23 din `_meta/inforce/pending-consolidations.json` (17 acte) și 23 de versiuni viitoare ale celor 16 acte din perimetrul actelor permisive. Eugen a ales **ambele** și **fișiere separate**.
- **Politica schimbată:** pînă acum wiki-ul ținea numai textul în vigoare azi (nota din `pending-consolidations.json`). Acum fiecare versiune viitoare e în `raw/papers/moldova-legal/viitor/<act>--<data>.md`, cu frontmatter `future_version_of`, `applies_from`, `in_force_warning` și banner. Textul de azi din `<act>.md` nu s-a atins.
- **Descărcare:** patru blob-uri, 46 de fișiere, 14,8 MB, aprobate explicit cu lista și mărimea; hash SHA-256 pe parte, dimensiune, id și contiguitate verificate la despachetare, 46 din 46. Cloudflare a reactivat verificarea în timpul enumerării (403); după ce Eugen a trecut-o din nou a mers, iar tabul vechi rămînea în 403 chiar după aceea: a trebuit un tab nou.
- **Ingerare:** `ingest_business_law.py` cu 46 de intrări (`subdir`, `future_of`, `applies_from`), `verify_business_law.py` 0 eșecuri, 1.368 de titluri desfăcute cu dovada că fiecare e titlul vechi plus cuvintele de pe rîndurile următoare, verbatim (backup în `wiki-backups/wiki-2026-09-25-viitor-ring/`).
- **Capcană prinsă:** la trei versiuni (`L-19-2016--2030-01-01`, `L-82-2024--2028-05-08`, `L-22-2025--2027-03-27`) data dedusă din rîndul de modificare e mai veche decît data versiunii din lista legis.md. Cu data dedusă, registrul in-force nu le-ar fi văzut ca viitoare. Data din listă a devenit `consolidation_date`, iar cea dedusă a rămas în `consolidation_date_from_modification_line`.
